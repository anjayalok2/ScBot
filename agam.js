...
Click Button Dibawah Untuk Menampilkan List Menu.`
               ...
               buttons = [{buttonId:`menu`,buttonText:{displayText:'Menu'},type:1}]
				               locatione = (await agam.prepareMessageFromContent(from, {"locationMessage": { "degreesLatitude": 0, "degreesLongitude": 0}}, {thumbnail:fs.readFileSync('./media/Nakano.jpg')})).message.locationMessage
         ...
         agam.sendMessage(from, buffer, audio, { mimetype: 'audio/mp4', quoted: fg3, ptt: true })
                  }
